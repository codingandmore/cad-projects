...
with BuildPart() as part:
    with BuildSketch() as sketch:
        ...
        with Locations(Rot(Z=-30)): # perform a rotation coplanar with `Plane.XY               
        ...
        # three hole arms:
        with PolarLocations(0, 3, start_angle=30):
            ...
            with Locations((three_hole_radius, 0)):
                Circle(hole_diameter / 2, mode=Mode.SUBTRACT)        
        # two hole arms:
        with PolarLocations(0, 2, start_angle=50):
